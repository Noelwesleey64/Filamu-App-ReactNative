...
const getNowPlayingMoviesList = async () => {
  try {
    ...
    console.error("Something went wrong in nowPlayingMovies Function", error);
  }
};
...
const getUpcomingMoviesList = async () => {
  try {
    ...
    console.error(
      "Something went wrong in getUpcommingMoviesList Function",
      error
    );
  }
};
        ...
        renderItem={({ item, index }) => {
          ...
          return (
            <MovieCard
              ...
              ifLast={index == upcomingMovies?.length - 1 ? true : false}
